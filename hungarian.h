...
public:
    ...
    vector<std::vector<int>> hungarian()
    {
        ...
        vector<std::vector<int>> sol(problem_size, vector<int>(problem_size, 0));
    ...
    vector<std::vector<int>> assignmentProblem(int Arr[], int N)
    {
        ...
        vector<std::vector<int>> sol = hungarian();
